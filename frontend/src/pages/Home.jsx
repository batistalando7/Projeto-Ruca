        ...
        <>
            ...
            <div className="welcome-area" id="welcome">
                ...
                <div className="right-bg">
                    <img src="src/assets/images/photos/header.jpg" className="img-fluid float-right" alt=""/>
                </div>
                {/* ***** Header Background Image End ***** */}

                <div className="header-bg">
                    <img src="src/assets/images/header-bg.svg" className="img-fluid" alt=""/>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                            <img src="src/assets/images/photos/features/green-1.png" className="img-fluid d-block mx-auto" alt="App"/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                            <img src="src/assets/images/photos/features/green-2.png" className="img-fluid d-block mx-auto" alt="App"/>
                        </div>
                        <div className="col-lg-1"></div>
                        <div className="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
                            <div className="left-heading">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="blog-post-thumb">
                                ...
                                <div className="blog-content">
                                    <h3>
                                        <a href="green-blog-single.html">Alya Expands the Leadership Team with David Lin, Controller</a>
                                    </h3>
                                    <div className="text">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="blog-post-thumb">
                                ...
                                <div className="blog-content">
                                    <h3>
                                        <a href="green-blog-single.html">Alya Partners with Velocloud to Deliver Managed SD-WAN</a>
                                    </h3>
                                    <div className="text">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="blog-post-thumb">
                                ...
                                <div className="blog-content">
                                    <h3>
                                        <a href="green-blog-single.html">Corporate IT Solutions Adds Neva as Senior Account Executive</a>
                                    </h3>
                                    <div className="text">
                    ...
                    <div className="row">
                        <div className="col-lg-5 col-md-12 col-sm-12">
                            <img src="src/assets/images/logo-green.png" className="logo" alt=""/>
                                <div className="text">Morbi convallis bibendum urna ut viverra. Maecenas quis consequat libero, a feugiat eros. Nunc ut lacinia tortor morbi ultricies laoreet ullamcorper phasellus semper.</div>
                        </div>
